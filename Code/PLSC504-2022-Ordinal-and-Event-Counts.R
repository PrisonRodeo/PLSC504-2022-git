...
ANES <- as.data.frame(read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC504-2022-git/master/Data/ANES2016.csv"))
...
# 
# beer<-as.data.frame(get_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC504-2021-git/master/Data/Beer.csv"))
# 
# summary(beer)
# 
...
wars<-as.data.frame(read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC504-2022-git/master/Data/wars.csv"))
