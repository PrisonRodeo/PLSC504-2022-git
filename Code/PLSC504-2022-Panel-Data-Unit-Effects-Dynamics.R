...
library(prais)
library(nlme)
library(panelAR) # Note: This package is currently (10/11/22) archived; see
...
wdi<-read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC504-2022-git/master/Data/WDI.csv")
