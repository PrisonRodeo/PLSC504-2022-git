...
Cities <- read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC504-2022-git/master/Data/USCities.csv")
Cities <- Cities[1:10,]
...
ANES <- read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC504-2022-git/master/Data/ANES2016.csv")
